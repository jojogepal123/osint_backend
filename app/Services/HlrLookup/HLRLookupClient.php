...
include 'HLRRESTClient.php';
include 'HLRRESTClientResponseObject.php';
include 'HLRLoggingService.php';
/**
...
class HLRLookupClient extends HLRRESTClient
{
    ...
    public function get($endpoint = '/', $params = [])
    {
        ...
        $response = parent::sendRequest($endpoint, $method, [], false, $params, $authHeaders, $this->buildCustomOptions());
    ...
    public function post($endpoint = '/', $params = [])
    {
        ...
        $method = 'POST';
        $authHeaders = $this->buildAuthHeaders($endpoint, $method, $params);
        $response = $this->sendRequest($endpoint, $method, $params, true, [], $authHeaders, $this->buildCustomOptions());
     ...
     * @return array
     */
    private function buildAuthHeaders($path, $method, $params = [])
    {
    ...
    private function fetchTimestamp()
    {
        ...
        $timestamp = time();
        $client = new HLRRESTClient('https', 'www.hlr-lookups.com', '/api/v2');
    ...
    private function buildCustomOptions()
    {
        ...
        return [CURLOPT_USERAGENT => $this->clientName.' '.$this->clientVersion.' ('.$this->key.')'];
