...
<head>
  <meta charset="UTF-8">
  <title>AI Phone Intelligence Report</title>
...
@include('report.partials.header', ['reportType' => 'AI Phone Intelligence Report'])
        ...
        <tr>
          @foreach($profileImagesForPdf as $img)
            <td align="center" style="border:1px solid #d0dce8; background:#f8faff; border-radius:4px;">
              <p style="font-size:10px; font-weight:bold; color:#0f3460; margin:0 0 4px;">{{ $img['platform'] }}</p>
